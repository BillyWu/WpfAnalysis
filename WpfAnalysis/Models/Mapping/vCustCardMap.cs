...
{
    public class vCustCardMap : EntityTypeConfiguration<vCustCard>
    {
        public vCustCardMap()
        {
            // Primary Key
            this.HasKey(t => new { t.用户编号, t.性别, t.类型, t.卡号, t.状态, t.押金, t.金额, t.有效期, t.accessmode, t.dinner });
